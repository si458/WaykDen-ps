...
On RYOUNG-PC, launch Wayk Now, type "899769" in the "Target ID" field and click "Connect":

image::images/now_connect_ryoung_to_dford.png[Wayk Now - ryoung connecting to dford]
